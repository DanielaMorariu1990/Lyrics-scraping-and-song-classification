"""
Taking input from spider
Processing data: bag of words, vectorizing data
Fitting: Random forest, naive bayes
Predciting: whcih song belongs to which artist
Drawbacks: too few data (limited songs per artist) in order to amke too acurate predictions
"""
